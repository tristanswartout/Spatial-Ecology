...
Now lets remove setseed and run it again to see what the new value is 
```{r}
...
It looks like both graphs tell a similar story of distance apart between both critter types.
